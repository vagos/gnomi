...
\usepackage{xspace}
\usepackage{unixmanual}

\newcommand{\ttt}[1]{\texttt{#1}}
\renewcommand{\dots}{\ \dotfill{}\ } % Fills in the right amount of dots
\newcommand{\shortcut}[2]{#1~\dotfill{}~\ttt{#2}\\} % Custom command for adding a shorcut
...
That's why you are \say{limited} to only two (2) workspaces: \ttt{main} and \ttt{other}.
